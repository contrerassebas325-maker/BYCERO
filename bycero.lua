...
local btnClose=topBtn("✕",-28,C.Red)
...
paragraph(TabInicio.Page,"Bycero Hub v1.3","<font color='#00ff80'>+ Shaders Noche/Pink/Tokyo</font>\n<font color='#00ff80'>+ FPS Boost</font>\n<font color='#00ff80'>+ Guardar/Cargar Config</font>")
